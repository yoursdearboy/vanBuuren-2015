...
lines(vb$age, qBCCG(0.16, vb$Mu, vb$Su, vb$Lu), col = "cyan", lwd = 2)
lines(vb$age, qBCCG(0.5, vb$Mu, vb$Su, vb$Lu), col = "cyan", lwd = 2)
lines(vb$age, qBCCG(0.84, vb$Mu, vb$Su, vb$Lu), col = "cyan", lwd = 2)
```
