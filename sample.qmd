...
find_shape <- function(data, x0, y0, n) {
  found <- res <- closest_right(data, x0, y0)
...
write_csv(data, "sample/v1/100k.csv")

data <- data |>
  sample_n(1e4)

write_csv(data, "sample/v1/10k.csv")

data <- data |>
  sample_n(1e3)

write_csv(data, "sample/v1/1k.csv")

data <- data |>
  sample_n(5e2)

write_csv(data, "sample/v1/500.csv")

data <- data |>
  sample_n(2.5e2)

write_csv(data, "sample/v1/250.csv")
```
